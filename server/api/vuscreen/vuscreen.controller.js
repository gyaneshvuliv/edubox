...
function insertChat(data) {
  return new Promise(function (myResolve, myReject) {
    let query = "insert into tbl_chat set ?";
    let json = {
...
function insertEvent(data) {
  return new Promise(function (myResolve, myReject) {
    let query = "insert into tbl_events set ?";
    let json = {
      ...
      unique_mac_address: data.unique_mac_address,
      number_of_unique_user: data.number_of_unique_user
    }
    db.get().query(query, json, function (err, device) {
      if (err) { myResolve(err) }
      else {
...
function insertTracker(data) {
  return new Promise(function (myResolve, myReject) {
    let query = "insert into tbl_tracker set ?";
    let json = {
      partner: data.partner,
      reg_id: data.reg_id,
      event_id: data.event_id,
